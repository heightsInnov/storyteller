        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card card-profile">
                    ...
                    <div class="card-body">
                        <h6 class="card-category text-gray">{{ $user->is_story_teller != 1 && $user->is_story_seeker != 1 ? "Admin" : "" }}
{{ $user->is_story_teller == 1 && $user->is_story_seeker != 1 ? "Story Teller" : "" }}
{{ $user->is_story_teller != 1 && $user->is_story_seeker == 1 ? "Story Seeker" : "" }}</h6>
